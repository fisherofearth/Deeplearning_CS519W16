...
if __name__ == '__main__':                    
    ...
    model.add(Dense(512))
    model.add(Activation('relu'))
    model.add(Dropout(0.)) # No dropout 

    model.add(Dense(nb_classes))
    #model.add(Activation('softmax'))
    
    model.add(Layer(trainable = False, input_shape = (10,)))

    model.load_weights('model_1_wght.h5')
    ...
    if not data_augmentation:
        ...
        open('model_2_arch.json', 'w').write(json_string)
        model.save_weights('model_2_wght.h5')
